    ...
    <div className="flexBetweenStart my-5">
      <div className="flex-1 flexStartCenter">
        <div className="relative w-28 h-28 ">
          <Image src={nft.image || images[`nft${nft.i}`]} layout="fill" objectFit="cover" className="rounded-xl" />
        </div>
...
const NFTDetails = () => {
  ...
  const [nft, setNft] = useState({ img: '', tokenId: '', name: '', owner: '', price: '', seller: '' });
    ...
    <div className="relative flex justify-center md:flex-col min-h-screen">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10 flex flex-col">
          ...
          <div className="mt-3 ">
            <p className="font-poppins dark:text-white text-nft-black-1 text-base font-normal mb-2">{nft.description}</p>
          </div>
        </div>
        ...
        <Modal
          ...
          footer={(
            <div className="flex flex-row sm:flex-col">
              <Button
                btnName="checkout"
                classStyles="mr-5 sm:mr-0 sm:mb-2 rounded-xl"
        ...
        footer={(
          <div className="flexCenter flex-col">
            <Button
              ...
              classStyles="sm:mb-2 sm:mr-0 rounded-xl"
